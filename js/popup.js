...
offerElement.querySelector('.popup__type').textContent = offerTypes.similarOffers[0].offer.type; //вывести тип жилья сопоставив с подписями
...
offerElement.querySelector('.popup__avatar').textContent = similarOffers[0].offer.title; //значение атрибута src
